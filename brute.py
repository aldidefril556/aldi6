...
def banner():
    ...
    print GG+"  √=============================================√"
    print WW+"  |            MOD BY: ALDI DEFRIL              |"
    print GL+"  |       Berdoa Dulu Sebelum Menggunakan       |"
    print WW+"  |            FACEBOOK: ALDI DEFRIL            |"
    print Y+"  |             INSTAGRAM: ALDI_DEFRIL              |"
    print GL+"  |---------------------------------------------|"
    print GL+"  |        LIFE OF PROGRAMMER [ L.O.P ]         |"
    print GL+"  |---------------------------------------------|"
    print GG+"  √=============================================√"
    print GL+"  |•••••••••   HACK FACEBOOK SOB ^_^   •••••••••|"
    print GG+"  √=============================================√"

banner()

print wd+"         https://www.github.com/aldidefril "
